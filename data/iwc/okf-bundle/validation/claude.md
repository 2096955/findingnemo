...
- `db-match-2026-06-batch7.md` (Validation Report): **Sample DB match report — batch 7 (illustrative)** — Synthetic validation report comparing extracted cases to sample DB export.
