...
async def subscribe_to_task_events(
    ...
    try:
            ...
            try:
                ...
                while True:
                    ...
                    try:
                        ...
                        log.debug(
                            "%sSSE queue wait timed out (iteration %d), sending heartbeat.",
                            log_prefix,
                            loop_count,
                        )
                        # Send a heartbeat comment to prevent Cloud Run LB from
                        # closing idle SSE connections during long orchestration gaps.
        ...
        # ping=25 sends an SSE `:` comment every 25s — keeps Cloud Run LB alive
